...
namespace SA
{
	namespace HI
	{
		...
		{
			static_assert(std::is_base_of<Object, T>::value, L"Handled interface type should inherit from HI::Object");
		}
		...
		bool InterfaceList<T>::Erase(AT* _object, DestroyFunctor _destroyer)
		{
			...
			SA_LOG(L"Object [" << _object << L"] not found in list", Error, SA/HI);
